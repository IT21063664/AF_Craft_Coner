...
function NewProduct() {
   ...
   function handleRemoveImg(imgObj) {
    ...
    function handleSubmit(e) {
        ...
        createProduct({ name, description, price, quantity, category, images }).then(({ data }) => {
            if (data.length > 0) {
                setTimeout(() => {
                    navigate("/");
                }, 1500);
                    ...
                    <Form style={{ width: "100%" }} onSubmit={ handleSubmit }>
                        ...
                        <Form.Group className="mb-3" onChange={(e) => setCategory(e.target.value)}>
                            ...
                            <Form.Select>
                                ...
                                <option value="gems_and_jewelry">gems_and_jewelry</option>
                                <option value="ayurvedic_products">ayurvedic_products</option>
                                <option value="batik_paintings">batik_paintings</option>
                                <option value="clothing_and_textiles">clothing_and_textiles</option>
                                <option value="musical_instruments">musical_instruments</option>
                                <option value="leather_goods">leather_goods</option>
                            </Form.Select>
                        </Form.Group>
